...
<html lang="en">
    <head>
        ...
        <title> Home | Tugas Akhir Sistem Informasi Penualan</title>
                    ...
                    <div id="page-content">
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Input Data Admin</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                            ...
                            <?php
                                ...
                                $sql = "select max(id_admin) from tb_admin";
                                $query = mysqli_query($konek, $sql);
                                $kode_admin = mysqli_fetch_array($query);

                                if($kode_admin){
                                    $nilai = substr($kode_admin[0], 1);
                                    $kode = (int)$nilai;

                                    $kode = $kode+1;
                                    $auto_kode = "A".str_pad($kode, 3, "0", STR_PAD_LEFT);
                                }else{
                                    $auto_kode = "A001";
                                }
                            ?>
                                
                <form method= "post" action="prosesInputAdmin.php" enctype="multipart/form-data">
                <div class="form-group" style="padding: 20px">
                    <label class="col-md-3 control-label" for="demo-text-input">Id Admin</label>
                    <div class="col-md-9">
                        <input type="text" name="id_admin" value="<?php echo $auto_kode;?>" readonly="readonly" id="demo-text-input" class="form-control" placeholder="Id Admin">
      
                    </div>
                </div>
                <div class="form-group" style="padding: 20px">
                    <label class="col-md-3 control-label" for="demo-text-input">Nama Admin</label>
                    <div class="col-md-9">
                        <input type="text" name="nama_admin" id="demo-text-input" class="form-control" placeholder="Nama Admin">
      
                    </div>
                </div>
                <div class="form-group" style="padding: 20px">
                <input type="submit" name="submit" value="Simpan">
                <a href="dataAdminRegister.php"><input type="button" value="Batal"></a>
            </div>
                                ...
                                <div class="nano-content">
                                    <ul id="mainnav-menu" class="list-group">
                                        ...
                                        <li>
                                            ...
                                            <!--Submenu-->
                                            <ul class="collapse">
                                                <li><a href="inputAdmin.php"><i class="fa fa-caret-right"></i> Input Admin </a></li>
                                                <li><a href="dataAdminRegister.php"><i class="fa fa-caret-right"></i> Data Admin </a></li>
                                            </ul>
                                        </li>
                                        <!--Menu list item-->
                                        <!--Menu list item-->
