                    ...
                    <div id="page-content">
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Input Data Setor Barang</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                            ...
                            <?php
                                ...
                                $sql = "select max(id_st) from tb_setor";
                                $query = mysqli_query($konek, $sql);
                                $kode_st = mysqli_fetch_array($query);

                                if($kode_st){
                                    $nilai = substr($kode_st[0], 1);
                                    $kode = (int)$nilai;

                                    $kode = $kode+1;
                                    $auto_kode = "R".str_pad($kode, 3, "0", STR_PAD_LEFT);
                                }else{
                                    $auto_kode = "R001";
                                }
                            ?>
                                
                            <form method= "post" action="prosesInputSetor.php" enctype="multipart/form-data">
                            <div class="form-group" style="padding: 20px">
                                <label class="col-md-3 control-label" for="demo-text-input">Id Setor</label>
                                <div class="col-md-9">
                                    <input type="text" name="id_st" value="<?php echo $auto_kode;?>" readonly="readonly" id="demo-text-input" class="form-control" placeholder="Id Setor">
                  
                                </div>
                            </div>
                            <div class="form-group" style="padding: 20px">
                                <label class="col-md-3 control-label" for="demo-text-input">Tgl Setor</label>
                                <div class="col-md-9">
                                    <input type="date" name="tgl_set" id="demo-date-input" class="form-control" placeholder="Tgl Setor">
                            ...
                            <div class="form-group" style="padding: 20px">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="jumlah_set" id="demo-number-input" class="form-control" placeholder="Jumlah">
                  
                                </div>
                            </div>
                            <div class="form-group" style="padding: 20px">
                                <input type="submit" name="submit" value="Simpan">
                                <a href="dataSetor.php"><input type="button" value="Batal"></a>
                            </div> 
