                    ...
                    <!--===================================================-->
                     ...
                     <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Ubah Data Admin</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                ...
                                ?>
                            <form method="post" action="proses_ubahAdmin.php?id_admin=<?php echo $id_admin; ?>" enctype="multipart/form-data">
                                <div class="form-group" style="padding: 20px">
                                    <label class="col-md-3 control-label" for="demo-text-input">Nama Admin</label>
                                    <div class="col-md-9">
                                        <input type="text" name="nama_admin" id="demo-text-input" class="form-control" placeholder="Nama Admin" value="<?= $data['nama_admin']; ?>">
