                    ...
                    <!--===================================================-->
                     ...
                     <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Ubah Data Barang</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                ...
                                ?>
                            <form method="post" action="proses_ubahSetor.php?id_st=<?php echo $id_st; ?>" enctype="multipart/form-data">
                                <div class="form-group" style="padding: 20px">
                                <label class="col-md-3 control-label" for="demo-text-input">Tgl Setor</label>
                                <div class="col-md-9">
                                    <input type="date" name="tgl_set" id="demo-date-input" class="form-control" placeholder="Tgl Setor" value="<?= $data['tgl_set']; ?>">
                            ...
                            <div class="form-group" style="padding: 20px">
                                ...
                                <div class="col-md-9">
                                <input type="text" name="id_br"  id="id_br" class="form-control" placeholder="Id Barang" value="<?= $data['id_br']; ?>" >
                                </div>
                            </div>
                            <div class="form-group" style="padding: 20px">
                            <label class="col-md-3 control-label" for="demo-text-input"> Nama Barang</label>
                                <div class="col-md-9">
                                    <input type="text" name="nama_br"  id="nama_br" class="form-control" placeholder="Nama Barang" value="<?= $data['nama_br']; ?>">
                             ...
                             <div class="form-group" style="padding: 20px">
                                ...
                                <div class="col-md-9">
                                <input type="text" name="jumlah_set"  id="id_br" class="form-control" placeholder="Jumlah" value="<?= $data['jumlah_set']; ?>">
                                </div>
                            </div>
