                     ...
                     <div class="panel">
                            ...
                            <div class="table-responsive">
                                ...
                                while($data = mysqli_fetch_array($sql)){
                                  ...
                                  echo "<td>".$data['stok_br']."</td>";
                                  echo "<td>".$data['satuan_br']."</td>";
                                  echo "<td>".$data['ket']."</td>";
                                  echo "<td>".$data['status_br']."</td>";
                                  echo "<td>".$data['gbr']."</td>";
                                  echo "<td><a href='hapusBarang.php?id_br=".$data['id_br']."'>Hapus</a></td>";
                                  echo "<td><a href='UbahBarang.php?id_br=".$data['id_br']."'>Ubah</a></td>";
                                  echo "</tr>"; 
                                }
                                ?>
                                </table>
