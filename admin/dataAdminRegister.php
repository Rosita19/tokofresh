                    ...
                    <!--===================================================-->
                     ...
                     <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Data Admin</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                <div class="pad-btm form-inline">
                                    <div class="row">
                                     <?php
                                          include 'koneksi.php';
                                          ?>
                                          <form action="cariAdminRegister.php" method="get">
                                          <label>
                            ...
                            <div class="table-responsive">
                                ...
                                while($data = mysqli_fetch_array($sql)){
                                  ...
                                  echo "<td><a href='hapusAdminRegister.php?id_admin=".$data['id_admin']."'>Hapus</a></td>";
                                  echo "<td><a href='buatAkun.php?id_admin=".$data['id_admin']."'>Buat Akun</a></td>";
