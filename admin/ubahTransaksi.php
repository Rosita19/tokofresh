                    ...
                    <!--===================================================-->
                     ...
                     <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Ubah Data Transaksi</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                ...
                                ?>
                            <form method="post" action="proses_ubahTransaksi.php?id_tk=<?php echo $id_tk; ?>" enctype="multipart/form-data">
                                <div class="form-group" style="padding: 20px">
                                    <label class="col-md-3 control-label" for="demo-text-input">Nama Pembeli</label>
                                    <div class="col-md-9">
                                        <input type="text" name="nama_pembeli" id="demo-text-input" class="form-control" placeholder="Nama Pembeli" value="<?= $data['nama_pembeli']; ?>">
                                ...
                                <div class="form-group" style="padding: 20px">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="no_rek" id="demo-text-input" class="form-control" placeholder="No Rek" value="<?= $data['no_rek']; ?>">
                                ...
                                <div class="form-group" style="padding: 20px">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="nama_rek" id="demo-text-input" class="form-control" placeholder="Nama Rek" value="<?= $data['nama_rek']; ?>">
                      
                                    </div>
                                </div>
                                <div class="form-group" style="padding: 20px">
                                    <label class="col-md-3 control-label" for="demo-text-input">Nama Bank</label>
                                        <div class="col-md-9">
                                ...
                                <a href="dataAdmin.php"><input type="button" value="Batal"></a>
                            </div>
                        </form>
                                </div>
                            </div>
