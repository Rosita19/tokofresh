                    ...
                    <!--===================================================-->
                     ...
                     <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Data Pembeli</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                <div class="pad-btm form-inline">
                                    <div class="row">
                                     <?php
                                          include 'koneksi.php';
                                          ?>
                                          <form action="cariPembeli.php" method="get">
                                          <label>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                 ...
                                 <?php 
                                      if (isset($_GET['cari'])) {
                                        $cari = $_GET['cari'];
                                        $sql = "select * from tb_pembeli where id_pembeli like '%".$cari."%' or nama_pembeli like '%".$cari."%'";
