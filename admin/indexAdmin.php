                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xm-12">
                                ...
                                <div class="panel media pad-all">
                                    ...
                                    <div class="media-body">
                                        <p class="text-2x mar-no text-thin text-right"><i class="fas fa-user-check"></i></p>
                                        <p class="h5 mar-no text-right"><a href="dataPembeli.php">Data Pembeli</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xm-12">
                                ...
                                <div class="panel media pad-all">
                                    ...
                                    <div class="media-body">
                                        <p class="text-2x mar-no text-thin text-right"><i class="fas fa-pills"></i></p>
                                        <p class="h5 mar-no text-right"><a href="dataPesanan.php">Data Pesanan</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xm-12">
                                ...
                                <div class="panel media pad-all">
                                    ...
                                    <div class="media-body">
                                        <p class="text-2x mar-no text-thin text-right"><i class="fas fa-pills"></i></p>
                                        <p class="h5 mar-no text-right"><a href="dataBarang.php">Data Barang</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xm-12">
                                ...
                                <div class="panel media pad-all">
                                    ...
                                    <div class="media-body">
                                        <p class="text-2x mar-no text-thin text-right"><i class="fas fa-pills"></i></p>
                                        <p class="h5 mar-no text-right"><a href="dataSetor.php">Data Setor</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xm-12">
                                ...
                                <div class="panel media pad-all">
                                    ...
                                    <div class="media-body">
                                        <p class="text-2x mar-no text-thin text-right"><i class="fa fa-edit"></i></p>
                                        <p class="h5 mar-no text-right"><a href="dataTransaksi.php">Data Transaksi</a></p>
                                    </div>
                                </div>
                            </div>
                              <div class="col-lg-3 col-md-3 col-sm-6 col-xm-12">
                                ...
                                <div class="panel media pad-all">
                                    ...
                                    <div class="media-body">
                                        <p class="text-2x mar-no text-thin text-right"><i class="fas fa-user-cog"></i></p>
                                        <p class="h5 mar-no text-right"><a href="dataAdmin.php">Data Admin</a></p>
                                    </div>
                                </div>
                         </div>
                     </div>
