                    ...
                    <div id="page-content">
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Input Data Barang</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                            ...
                            <?php
                                ...
                                $sql = "select max(id_br) from tb_barang";
                                $query = mysqli_query($konek, $sql);
                                $kode_br = mysqli_fetch_array($query);

                                if($kode_br){
                                    $nilai = substr($kode_br[0], 1);
                                    $kode = (int)$nilai;
                            ...
                            <form method= "post" action="prosesInputBarang.php" enctype="multipart/form-data">
                            <div class="form-group" style="padding: 20px">
                                <label class="col-md-3 control-label" for="demo-text-input">Id Barang</label>
                                <div class="col-md-9">
                                    <input type="text" name="id_br" value="<?php echo $auto_kode;?>" readonly="readonly" id="demo-text-input" class="form-control" placeholder="Id Barang">
                            ...
                            <div class="form-group" style="padding: 20px">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nama_br" id="demo-text-input" class="form-control" placeholder="Nama Barang">
                  
                                </div>
                            </div>
                           <div class="form-group" style="padding: 20px">
                                <label class="col-md-3 control-label" for="demo-text-input">Harga</label>
                                <div class="col-md-9">
                                    <input type="number" name="harga_br" id="demo-number-input" class="form-control" placeholder="Harga">
                  
                                </div>
                            </div>
                             <div class="form-group" style="padding: 20px">
                                <label class="col-md-3 control-label" for="demo-text-input">Stok</label>
                                <div class="col-md-9">
                                    <input type="number" name="stok_br" id="demo-number-input" class="form-control" placeholder="Stok">
                  
                                </div>
                            </div>
                             <div class="form-group" style="padding: 20px">
                                <label class="col-md-3 control-label" for="demo-text-input">Satuan</label>
                                <div class="col-md-9">
                                    <input type="text" name="satuan_br" id="demo-text-input" class="form-control" placeholder="Satuan">
                             ...
                             <div class="form-group" style="padding: 20px">
                                ...
                                <div class="col-md-9">
                                    <textarea name="ket" id="demo-textarea-input" rows="2" class="form-control" placeholder="Keterangan"></textarea>
                  
                                </div>
                            </div>
                            <div class="form-group" style="padding: 20px">
                                <label class="col-md-3 control-label" for="demo-text-input">Status Barang</label>
                                <div class="col-md-9">
                                    <select class="form-control" name="status_br">
                                        <option> -- Pilih Status </option>
                                        <option name="status_br" value="Old"> Old</option>
                                        <option name="status_br" value="New"> New</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" style="padding: 20px">
                                <label class="col-md-3 control-label" for="demo-text-input">Gambar</label>
                                <div class="col-md-9">
                                    <input type="file" name="gbr" style="height: 30px; color: white; background-color: dodgerblue;" />
                                </div>
