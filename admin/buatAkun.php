        ...
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <div class="boxed">
                    ...
                    <div id="page-content">
                     <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Buat Akun</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                ...
                                ?>
                <form method= "post" action="prosesInputLogin.php">
                <div class="form-group" style="padding: 20px">
                    <div class="col-md-9">
                        <?php
                        $id = $_GET['id_admin'];
                        $query = mysqli_query($konek, "select *from tb_admin where id_admin= '$id'" );
                        while ($data = mysqli_fetch_array($query)) {
                        ?>
                        <input type="text" name="username" id="demo-text-input" class="form-control" placeholder="Username" value="<?php echo $data['nama_admin'];} ?>" readonly>
               ...
               <div class="form-group" style="padding: 20px">
                ...
                <a href="inputAdmin.php"><input type="button" value="Batal"></a>
                </div>
