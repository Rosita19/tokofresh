                    ...
                    <!--===================================================-->
                     ...
                     <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Data Barang</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                <div class="pad-btm form-inline">
                                    <div class="row">
                                     <?php
                                          include 'koneksi.php';
                                          ?>
                                          <form action="cariSetor.php" method="get">
                                          <label>
                            ...
                            <div class="table-responsive">
                                ...
                                $query = "SELECT * FROM tb_setor";
                                $sql = mysqli_query($konek, $query);

                                while($data = mysqli_fetch_array($sql)){
                                  echo "<tr>";
                                  echo "<td>".$data['id_st']."</td>";
                                  echo "<td>".$data['tgl_set']."</td>";
                                  echo "<td>".$data['id_br']."</td>";
                                  echo "<td>".$data['nama_br']."</td>";
                                  echo "<td>".$data['jumlah_set']."</td>";
                                  echo "<td><a href='hapusSetor.php?id_st=".$data['id_st']."'>Hapus</a></td>";
                                  echo "<td><a href='UbahSetor.php?id_st=".$data['id_st']."'>Ubah</a></td>";
                                  echo "</tr>"; 
                                }
                                ?>
                                </table>
