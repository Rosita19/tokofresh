                    ...
                    <!--===================================================-->
                     ...
                     <div class="panel">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-users"></i>Data Setor</h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                 ...
                                 <?php 
                                      if (isset($_GET['cari'])) {
                                        $cari = $_GET['cari'];
                                        $sql = "select * from tb_setor where id_st like '%".$cari."%' or nama_br like '%".$cari."%'";
                                        $query = mysqli_query($konek, $sql);
                                        $data = mysqli_fetch_assoc($query);
                                      ?>
                                        <tr>
                                        <td><?php echo $data['id_st']; ?></td>
                                        <td><?php echo $data['tgl_set']; ?></td>
                                        <td><?php echo $data['id_br']; ?></td>
                                        <td><?php echo $data['nama_br']; ?></td>
                                        <td><?php echo $data['jumlah_set']; ?></td>
                                        </tr>
                                          <?php
                                       }
                                       ?>
