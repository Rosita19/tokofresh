                    ...
                    <!--===================================================-->
                     ...
                     <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                ?>
                            <form method="post" action="proses_ubahBarang.php?id_br=<?php echo $id_br; ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group" style="padding: 20px">
                                 ...
                                 <div class="form-group" style="padding: 20px">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" name="stok_br" id="demo-number-input" class="form-control" placeholder="Stok Barang" value="<?= $data['stok_br']; ?>">
                                 ...
                                 <div class="form-group" style="padding: 20px">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="satuan_br" id="demo-text-input" class="form-control" placeholder="Satuan Barang" value="<?= $data['satuan_br']; ?>">
                                 ...
                                 <div class="form-group" style="padding: 20px">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="ket" id="demo-text-input" class="form-control" placeholder="Keterangan" value="<?= $data['ket']; ?>">
