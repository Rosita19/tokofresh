                     ...
                     <div class="panel">
                                ...
                                <div class="pad-btm form-inline">
                                    <div class="row">
                                     <?php
                                          include 'koneksi.php';
                                          ?>
                                          <form action="cariTransaksi.php" method="get">
                                          <label>
                            ...
                            <div class="table-responsive">
                                ...
                                while($data = mysqli_fetch_array($sql)){
                                  echo "<tr>";
                                  echo "<td>".$data['id_tk']."</td>";
                                  echo "<td>".$data['id_pembeli']."</td>";
                                  echo "<td>".$data['nama_pembeli']."</td>";
                                  echo "<td>".$data['alamat']."</td>";
                                  echo "<td>".$data['totalseluruh']."</td>";
                                  echo "<td>".$data['no_rek']."</td>";
                                  echo "<td>".$data['nama_rek']."</td>";
                                  echo "<td>".$data['bank']."</td>";
                                  echo "<td>".$data['tgl_tr']."</td>";
                                  echo "<td><a href='hapusTransaksi.php?id_tk=".$data['id_tk']."'>Hapus</a></td>";
                                  echo "<td><a href='ubahTransaksi.php?id_tk=".$data['id_tk']."'>Ubah</a></td>";
                                  echo "</tr>"; 
                                }
                                ?>
                                </table>
