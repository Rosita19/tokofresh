				...
				<div class="col-md-9">
                            ...
                            <div class="table-responsive">
                                ...
                                while($data = mysqli_fetch_array($sql)){
                                  ...
                                  echo "<td><a href='UbahPesan.php?id_pes=".$data['id_pes']."'>Ubah</a></td>";
                                  echo "</tr>"; 
                    ...
                    <!--</div> -->
                    		<?php
                                ...
                                $kode_transaksi = mysqli_fetch_array($query);

                                if($kode_transaksi){
                                    $nilai = substr($kode_transaksi[0], 2);
                                    $kode = (int)$nilai;
			        ...
			        <div id="kasirnya">
			            <table class="table table-stripped">
			                <?php
				                 $query = mysqli_query($konek, "select sum(total) as totalseluruh, nama_pembeli from pesan group by status = 'Sudah Dibayar'");
                		...
                		<div class="form-group" style="padding: 20px">
			             ...
			             <div class="form-group" style="padding: 20px">
			                <input type="submit" name="submit" value="Kirim" class="btn btn-lg btn-danger">
