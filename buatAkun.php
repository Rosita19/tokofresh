  ...
  <div class="container">
            ...
            <!-- start: Table -->
                 <div class="table-responsive">
                    <br>
                 <div class="title"><h3>Form Buat Akun Pembeli</h3></div>
                ...
                <div class="form-group" style="padding: 20px">
                    <div class="col-md-9">
                        <?php
                        $id = $_GET['id_pembeli'];
                        $query = mysqli_query($konek, "select *from tb_pembeli where id_pembeli= '$id'" );
                        while ($data = mysqli_fetch_array($query)) {
                        ?>
                        <input type="text" name="username" id="demo-text-input" class="form-control" placeholder="Username" value="<?php echo $data['nama_pembeli'];} ?>" readonly>
               ...
               <div class="form-group" style="padding: 20px">
                ...
                <a href="inputPembeli.php"><input type="button" value="Batal"></a>
                </div>
